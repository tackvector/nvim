...
if vim.fn.has('win32') == 1 then
    jdtls_path = 'C:\\Users\\Struct\\jdt-language-server-latest'
    java_path = 'C:\\Program Files\\Java\\jdk-21\\bin\\java'
    launcher_jar = vim.fn.glob(jdtls_path .. '\\plugins\\org.eclipse.equinox.launcher_1.6.800.v20240513-1750.jar')
else
    jdtls_path = '/home/tackvector/jdtls-latest/'
